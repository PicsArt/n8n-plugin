...
export async function executeUltraEnhance(
	...
	// Prepare form data for ultra enhance (manual multipart - no form-data package)
	...
	try {
		// Call Picsart API to ultra enhance image
	...
	returnData.push({
		binary: {
			data: await context.helpers.prepareBinaryData(imageBuffer, 'ultra-enhanced.png'),
		},
		json: {
